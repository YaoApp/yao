...
// ============================================================================
// InputFormatter — FormatClockContext
// ============================================================================

func TestInputFormatterFormatClockContextUnit(t *testing.T) {
...
// ============================================================================
// InputFormatter — FormatRobotIdentity
// ============================================================================

func TestInputFormatterFormatRobotIdentityUnit(t *testing.T) {
	formatter := standard.NewInputFormatter()

	t.Run("formats robot identity with duties and rules", func(t *testing.T) {
		robot := &types.Robot{
			MemberID: "test-robot",
			Config: &types.Config{
				Identity: &types.Identity{
					Role:   "Data Analyst",
					Duties: []string{"Analyze data", "Create reports"},
					Rules:  []string{"Be accurate"},
				},
			},
		}

		result := formatter.FormatRobotIdentity(robot)
	...
	t.Run("returns empty for nil robot", func(t *testing.T) {
		result := formatter.FormatRobotIdentity(nil)
		assert.Empty(t, result)
	})
...
// ============================================================================
// InputFormatter — FormatInspirationReport
// ============================================================================

func TestInputFormatterFormatInspirationReportUnit(t *testing.T) {
	formatter := standard.NewInputFormatter()
...
// ============================================================================
// InputFormatter — FormatTriggerInput
// ============================================================================

func TestInputFormatterFormatTriggerInputUnit(t *testing.T) {
	formatter := standard.NewInputFormatter()
...
// ============================================================================
// InputFormatter — FormatGoals (without resources, pure logic only)
// ============================================================================

func TestInputFormatterFormatGoalsUnit(t *testing.T) {
	formatter := standard.NewInputFormatter()
	...
	t.Run("includes delivery target when present", func(t *testing.T) {
		goals := &types.Goals{
			Content: "Send report",
		...
		assert.Contains(t, result, "## Delivery Target")
...
// ============================================================================
// InputFormatter — FormatTasks
// ============================================================================

func TestInputFormatterFormatTasksUnit(t *testing.T) {
	formatter := standard.NewInputFormatter()
...
// ============================================================================
// InputFormatter — FormatTaskResults
// ============================================================================

func TestInputFormatterFormatTaskResultsUnit(t *testing.T) {
	formatter := standard.NewInputFormatter()
...
// ============================================================================
// InputFormatter — FormatExecutionSummary
// ============================================================================

func TestInputFormatterFormatExecutionSummaryUnit(t *testing.T) {
	formatter := standard.NewInputFormatter()
...
// ============================================================================
// InputFormatter — BuildMessages
// ============================================================================

func TestInputFormatterBuildMessagesUnit(t *testing.T) {
	formatter := standard.NewInputFormatter()
...
func TestInputFormatterBuildMessagesWithSystemUnit(t *testing.T) {
	formatter := standard.NewInputFormatter()
