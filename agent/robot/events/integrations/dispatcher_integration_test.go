...
func TestLoadAll_OnlyTelegramConfigured(t *testing.T) {
	...
	d := integrations.NewDispatcher(cache, map[string]integrations.Adapter{"telegram": tgAdapter})
...
func TestLoadAll_MultipleAdapters(t *testing.T) {
	...
	d := integrations.NewDispatcher(cache, map[string]integrations.Adapter{
		"telegram": tgAdapter,
