...
✨ **所有 Agent 和工作区集中管理，覆盖你的每一台设备。任务看板追踪进度，桌面端、移动端、浏览器、API 随时访问。自托管。**
...
Agent 运行在你自己的设备上。每添加一台机器，就多一个它们的工作场所，所有设备统一管理。

## 工作区

每个工作区相互隔离。工作内容分开管理，跨设备协同，逐步积累为文档，成为你的知识库。
...
持续对话、持续运行，随着使用不断改进，最终成长为专门应对这类工作的 Agent。
